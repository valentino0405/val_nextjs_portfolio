              ...
              <div className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-white/10 rounded-xl p-4">
                    ...
                    <p className="text-white/70 text-sm">MERN and Socket.io +plus more for real-time chatting yesssss</p>
                  </div>
                  <div className="bg-white/10 rounded-xl p-4">
                    <h4 className="font-semibold text-purple-300 mb-2">FlipKart Clone</h4>
                    <p className="text-white/70 text-sm">MERN + Paymentuu Gateway(Stripe)</p>
                  </div>
                  <div className="bg-white/10 rounded-xl p-4">
                    <h4 className="font-semibold text-purple-300 mb-2">Virtual Assistan and ai t</h4>
                    <p className="text-white/70 text-sm">Python+ rustt + Gemini ii+ GPT api used (Collaborated with Dhaval Suthar)</p>
                  </div>
                </div>
              </div>
            </section>
